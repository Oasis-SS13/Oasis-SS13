...
/client/proc/place_ruin()
	...
	names += "---- Sand Ruins ----" // ScorchStation Underground
	for(var/name in SSmapping.sand_underground_ruins_templates)
		names[name] = list(SSmapping.sand_underground_ruins_templates[name], ZTRAIT_SAND_RUINS, /area/sandland/surface/outdoors/unexplored)
