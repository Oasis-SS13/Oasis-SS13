/* Pretty much copied from monkey_defense since the old savvy coders decided to define these procs in each separate carbon child instead of the carbon type itself */
...
/mob/living/carbon/shoepacabra/attack_paw(mob/living/M)
...
/mob/living/carbon/shoepacabra/attack_larva(mob/living/carbon/alien/larva/L)
...
/mob/living/carbon/shoepacabra/attack_hand(mob/living/carbon/human/M)
	if(..())
		return
	...
	switch(M.a_intent)
		...
		if(INTENT_DISARM)
			...
			if(clawed)  // The big boy shouldn't be pushed around so easily
				return 1
			M.do_attack_animation(src, ATTACK_EFFECT_DISARM)
			Knockdown(40)
...
/mob/living/carbon/shoepacabra/attack_alien(mob/living/carbon/alien/humanoid/M)
...
/mob/living/carbon/shoepacabra/attack_animal(mob/living/simple_animal/M)
	. = ..()
	if(.)
...
/mob/living/carbon/shoepacabra/attack_slime(mob/living/simple_animal/slime/M)
...
/mob/living/carbon/shoepacabra/acid_act(acidpwr, acid_volume, bodyzone_hit)
	. = 1
...
/mob/living/carbon/shoepacabra/ex_act(severity, target, origin)
